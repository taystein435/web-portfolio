  ...
  return (
    <div className='flex justify-around items-center p-10 space-x-10 lg:flex-row ssm:flex-col ssm:space-y-10 text-white' id='home'>
        <div className='lf:w-1/2 ssm:w-fit'>
            <img src={me} alt="" className="rounded-full w-60 h-60 object-cover mx-auto border-8 border-white" />

            <p className='text-2xl mx-16 m-5'> 
            <Typewriter
  options={{
    strings: ["Hi, I'm Taiwo Babatunde Abdul.","I am a highly skilled Full Stack Web and Mobile Developer."],
    autoStart: true,
    loop: true,
  }}
/></p>
